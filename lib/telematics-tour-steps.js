...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    description:
      "In the API Sandbox, this is your starting point for every demo. Each run picks 10 random drivers from a pool of 500 and generates synthetic scores — simulating Uber's telematics pipeline.",
  },
  {
    path: "/telematics/sandbox",
