...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    description:
      "In the API Sandbox, this is your starting point for every demo. Generate synthetic driving scores for 10 random drivers — simulating Uber's telematics data pipeline.",
  },
  {
    path: "/telematics/sandbox",
